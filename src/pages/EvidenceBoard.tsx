...
function EvidenceBoardFlow({ variant }: { variant: "page" | "modal" }) {
  ...
  const computedNodes: PolaroidNodeType[] = useMemo(() => {
    return profiles.map((p) => {
      ...
      const showNew = profileHasAnyNew(p, ack, vnRevealGate);
      const profileHref =
        variant === "modal"
